function nlogL = gamlikeJGM(a,b,data,censoring,freq)
...
%-------------------------------------------------------------------------%
% Revised: 07/18/16
%   -the original version, for obscure reasons, only allowed for scalar
%   values of the parameters--even tho' the code computing the actual -LL
%   is written for parameters that can be the same size as the data.
% Cribbed: 07/18/16
%   by JGM
%-------------------------------------------------------------------------%
...
%%% making this part run for matrix parameters will take more work.
