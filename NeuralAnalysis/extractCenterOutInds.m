...
%
% This function was designed to work with params.datatype = HHSreachData.  
% It takes the entire stimulus history, S (Ncases x Ndims x Nmods x T), and
% and extracts starting and ending indices of only the center-out reaches;
...
mvmtSpeed = shortdata(Ncases,2,sqrt((v(:,1).^2 + v(:,2).^2)));
