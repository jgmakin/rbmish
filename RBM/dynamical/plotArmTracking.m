function plotArmTracking(j,S0,params,varargin)
% plot the arm moving, and being tracked

% params
[Ncases,Ndims,Nmods,Nbatches] = size(S0);
dt = params.dynamics.A(1,Ndims+1);
setColors;
q = length(varargin)
...
w1 = params.w(:,1); q1 = params.q(:,1);
w2 = params.w(:,2); q2 = params.q(:,2);
...
for t = 1:Nbatches
    ...
    for fltr = 1:q
        ...
        poshat = FK2link(Xhat(j,1:2,t),params,1)';
