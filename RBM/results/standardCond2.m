...
%     for i = linspace(params.eyemin,params.eyemax,N)
    for i = linspace(params.thmin(1),params.thmax(1),N)
        for j = linspace(params.thmin(2),params.thmax(2),N)
...
for i = linspace(params.thmin(1),params.thmax(1),N)
    for j = linspace(params.thmin(2),params.thmax(2),N)
        ...
        if sum(k == plotvec)
            ...
            dispErrCovs(MargErrors,params.Ncases*1000,params);
