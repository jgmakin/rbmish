    ...
    % for iDirection = 0% :nDirections-1
        for i = 1:length(gainratios) 
            ...
            if iDirection == 0
                ...
                %%%% the argument to DATAGENPP inside test.m.  You always
                ...
                [D0,S0] = DATAGENPP(25,params,'propbias',shft);
                [Di,Si] = longdata(D0,S0);
                clear D0 S0;
              
                [avgErr,Do] = updown(Di,wts,params,'Nsamples');
