...
if Ndims > 1
    ...
    for iMod = 1:Nmods
        ...
        titlestr = ['Error Covariances, ',str,...
            ' Populations (u_max = ',num2str(params.g),')'];
        %%% titlestr = ['Error Covariances, ',str,...
    ...
    for iMod = 1:Nmods
        ...
        switch params.machine
            case {'kobayashi-maru','CUPCAKE','Themistocles'}
                ...
                tikzBarGraph(MSEs(iMod,~isnan(MSEs(iMod,:))),MSEerrorBars,...
                    2,0.32,...
                    xaxislabels(~isnan(MSEs(iMod,:))),'estimator',...
                    'mean square error','',...
                    clrNames(iMod,~isnan(MSEs(iMod,:))),...
