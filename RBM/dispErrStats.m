    ...
    case 1
        ...
        switch machine
            case {'kobayashi-maru','CUPCAKE','Themistocles','domestica'}
                ...
                tikzBarGraph(MSEs(~isnan(MSEs)),MSEerrorBars,2,0.32,...
                    xaxislabels(~isnan(MSEs)),'estimator',...
                    'mean square error','',clrNames(~isnan(MSEs)),...
...
%                 legend off, title('');
%                 matlab2tikzWrapper(['2DerrorStats',date],fighandle);
%                 close;
